        ...
        <>
          <div className="MainInfoProductNameDiv">
            ...
            <div style={{ display: "flex", "margin-top": "5px" }}>
              ...
              <a style={{ "margin-right": "5px" }}>3,496 ratings</a>{" "}
          ...
          <div className="MainInfoDetails">
            <div>
              ...
              <span
                style={{ "font-size": "28px", "vertical-align": "text-top" }}
              >
                7
              </span>
            ...
            <br></br>
            <a>
              Thank you for being a Prime member. Get a $100 Gift Card: Pay
              $0.00 upon approval for the Amazon Prime Rewards Visa Card. No
              annual fee.
            </a>{" "}
            <br></br>
            <br></br>
          ...
          <div>
            ...
            <div style={{ display: "flex", "font-size": "14px" }}>
              ...
              <div>
                <div style={{ "margin-bottom": "6px" }}>Small Business</div>
            ...
            <a style={{ "font-size": "14px" }}>
              <svg
                ...
                viewBox="0 0 16 12"
                style={{ color: "rgb(60, 60, 60)", "margin-right": "10px" }}
              >
